This folder contains data exported from Tapestri Insights 2.2 application.
...
GQ.csv - quality scores
    ...
    but they take more space in the file. So if the second most likely PL is greater than 99, we still

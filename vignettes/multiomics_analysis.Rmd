...
experiment = add_assay(experiment,filtered_variants)
...
p  = tapestri_scatterplot(
                 x = experiment$assays$dna$analysis_layers$projections$`Projection:glm_poi DR:glm_poi data:vaf`$x, 
                 y= experiment$assays$dna$analysis_layers$projections$`Projection:glm_poi DR:glm_poi data:vaf`$y, 
...
p = tapestri_ploidy_plot(
  ...
  clusters = experiment$assays$dna$analysis_layers$umap_vaf_clusters$feature.kmean.cluster.4
  )
p
```

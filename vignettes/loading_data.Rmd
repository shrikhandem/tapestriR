...
# Load multiomics H5 one layer at a time

In case you want to build a multiomics object from indivitual components, not using the `read_tap` function. 
...
### load cnv assay 
cnv = read_assay_h5(filename,assay_name = ASSAY_NAME_READ_COUNT)

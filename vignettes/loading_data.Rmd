...
* Tapestri Insights export supports only DNA analysis.
...
Usage:
* Load multi-sample multi-omics H5 file
...
## Load the data from a Tapestri Insights export
...
* Read the directory to create a new `Tapestri_Assay` Object.
